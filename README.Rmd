...
The last tremor or earthquake happened `r Last$place`, and had a magnitude of `r Last$mag`. The most intense tremor or earthquake in the last month happened  `r Max$place` and had a magnitude of `r Max$mag`, this was updated at `r Sys.time()`, just another t